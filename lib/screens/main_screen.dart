  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        willLeave = await showExitAlert.showAlertDialog(context, translate!.exitGameContentMessage, willLeave,
            cancelButton: translate.exitGameCancelButton, okButton: translate.exitGameOkButton);
        return willLeave;
      },
      child: Stack(
        children: [
              ...
              body: Center(
                child: Column(
                  ...
                  children: [
                          ...
                          return StreamBuilder(
                              stream: Stream.periodic(Duration(milliseconds: isNotVisibleTime), (_) {
                                if (isVisible == false) {
                                  ...
                                  mainScreenMessage =
                                      gameHelper.generateMainScreenMessages(translate!.keyboardLanguage);
                                } else {
                    ...
                    StartGameButton(
                      buttonLabelFirstLine: translate!.startQuickGameButtonFirstLine,
                    ...
                    StartGameButton(
                      buttonLabelFirstLine: translate.startTwoPlayerGameButtonFirstLine,
                      buttonLabelSecondLine: translate.startAnyGameButtonSecondLine,
                      onTapped: () {
